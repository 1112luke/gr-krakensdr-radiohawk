...
class krakensdr_source(gr.sync_block):
    ...
    def tcp_send_loop(self):
        ...
        #load up a buffer with the data
        while(buffcount < 52242880 and not self.stop_threads):
            buffer.append[self.tcp_send_queue.get()]
            buffcount += 1
